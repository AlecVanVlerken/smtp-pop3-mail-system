...
def main():
    ...
    smtp_port = 25
    pop3_port = 110  # POP3 is not used yet, but set it up for future implementation
    
    # Create and connect the SMTP socket
    smtp_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    smtp_socket.connect((server_ip, smtp_port))
    
    # Create and connect the POP3 socket (even though we won't use it yet)
